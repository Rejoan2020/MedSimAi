...
export default async function Page({ params }) {
  ...
  return (
    <div className="min-h-screen text-black flex flex-col justify-center w-full p-8 gap-6 min-w-200 w-full">
      ...
      <div className='flex justify-between'>
        <div className='flex'>
          <Image height={100} width={200} alt='person' src={'/cases/person.png'}
            className='h-30 w-36'
          />
          <div className="px-4 p-2 flex flex-col gap-2 max-w-300 min-w-100">
      ...
      <div className='flex flex-col gap-4 justify-between border border-gray-200 rounded-lg m-2 p-8'>
      ...
      <div className="grid h-[calc(100vh-10rem)] grid-cols-2 gap-6 p-6 w-full">
